...
class Check {
  ...
  public function __construct($_id, $_amount, $_check_date, $_letter_sent_date, $_account_number,
  $_routing_number, $_payment_recieved, $_store, $_company, $_account, $_letter_status) {
    $this->id = $_id;
    $this->amount = $_amount;
