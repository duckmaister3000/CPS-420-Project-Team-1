...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2017 at 04:17 AM
...
(1, '419.96', '2017-11-27', NULL, 1, 2, 1, 3, '1'),
...
(6, '324.14', NULL, NULL, 1, 2, 1, 29, '3'),
(7, '422.40', '2017-11-08', NULL, 0, 2, 1, 18, '1'),
(8, '666.31', '2017-09-20', NULL, 0, 2, 1, 5, '2'),
(9, '584.56', '2016-12-17', NULL, 0, 2, 1, 21, '3'),
(10, '225.23', NULL, NULL, 1, 1, 1, 22, '2'),
(11, '398.73', '2016-01-20', NULL, 0, 1, 1, 3, '2'),
(12, '393.09', NULL, NULL, 1, 2, 1, 8, '1'),
(13, '58.58', NULL, NULL, 1, 1, 1, 4, '2'),
(14, '144.99', NULL, NULL, 1, 1, 1, 5, '3'),
(15, '208.41', '2016-08-19', NULL, 0, 2, 1, 2, '2'),
(16, '780.72', '2017-04-25', NULL, 0, 2, 1, 1, '1'),
...
(23, '692.47', '2017-06-18', NULL, 0, 1, 1, 4, '1'),
(24, '70.56', '2017-02-16', NULL, 0, 1, 1, 8, '2'),
(25, '260.10', NULL, NULL, 1, 1, 1, 6, '3'),
...
(32, '999.99', '2017-10-05', NULL, 0, 2, 1, 32, '1');
...
--
ALTER TABLE `check`
  MODIFY `check_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
