...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2017 at 04:41 AM
...
(7, '422.40', '2017-11-08', '2017-11-23', 0, 2, 1, 18, '1'),
...
(16, '780.72', '2017-04-25', '2017-04-26', 0, 2, 1, 1, '1'),
...
CREATE TABLE `letter` (
  ...
  `letter_header` varchar(256) NOT NULL,
  `letter_body` longtext NOT NULL,
  `letter_footer` varchar(256) NOT NULL,
